 ...
 *
 * 예전 흐름은 "올리기 → 채우기 → 첫 질문"이었다. 올린 사진은 EXIF로 추억에
 * 자동으로 묶이고(또는 "2015년 기록" 같은 빈 추억이 새로 생기고), 그 추정은
 ...
 *
 * **어떤 사진이 같은 추억인지 사용자에게 묻지 않는다.** 첫 사용자는 앨범에서 아무
 * 사진이나 고르고, 그게 정상이다. 여러 추억이 섞여 있으면 날짜·좌표로 갈라 묶음마다
  ...
  return (
    <Page width={820}>
      <PageHeader
        ...
        lead="여러 추억의 사진이 섞여 있어도 됩니다. 촬영 시점과 장소로 묶어 초안을 만들고, 확인하고 저장하면 바로 가족 공간에 남습니다 — 다른 가족의 확인을 기다리지 않습니다."
      />
      ...
      >
        ...
        <p className="t-caption m-0 mt-2">
          {firstTime
            ? '몇 장이든 괜찮습니다. 같은 추억인 것만 골라 올리지 않아도 됩니다 · JPG · PNG · MP4 · M4A'
      ...
      {firstTime && (
        <p className="t-caption mt-4 max-w-[46em]">
          앨범에서 아무 사진이나 고르면 됩니다. 촬영 시점과 좌표를 읽어 같은 추억끼리 묶고,
